...
class ResnetBlockBigGANpp(nn.Module):
  ...
  def forward(self, x, temb=None, cemb=None):
    ...
    if temb is not None and cemb is not None:
      #h += self.Dense_0(self.act(temb))[:, :, None, None]
      temb = self.Dense_0(self.act(temb))[:, :, None, None]
      cemb = self.Dense_1(self.act(cemb))[:, :, None, None]
      h = cemb * h + temb
    elif temb is not None and cemb is None:
      h += self.Dense_0(self.act(temb))[:, :, None, None]

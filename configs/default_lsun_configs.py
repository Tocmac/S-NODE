...
def get_default_configs():
  ...
  config.training.batch_size = 60   
  training.n_iters = 2400001
  training.snapshot_freq = 50000   # modified
  ...
  evaluate.batch_size = 16 # modified
  evaluate.enable_sampling = False
  evaluate.enable_figures_only = False
  evaluate.num_samples = 100   # modified
